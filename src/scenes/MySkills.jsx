      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            ...
            like React and Bootstrap, which accelerate development and enhance
            user interfaces. With each project and challenge overcome, I have
            gained confidence, problem-solving skills, and a passion for
        ...
        >
          ...
          <p className="mt-5 z-[10]">
            ...
            have the opportunity to bring innovative ideas to life, create
            immersive user experiences and push the boundaries of web
            development.
          </p>
        </motion.div>
        {/* IMAGINATIVE */}
        ...
        >
          ...
          <p className="mt-5">
            ...
            innovative navigation systems, and engaging animations that
